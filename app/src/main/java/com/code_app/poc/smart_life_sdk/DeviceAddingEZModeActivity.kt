...
import kotlinx.android.synthetic.main.activity_device_adding_ezmode.*

class DeviceAddingEZModeActivity : AppCompatActivity() {
    companion object {
        const val TAG = "DeviceAddingEZMode"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_device_adding_ezmode)
        title = "Wi-Fi, EZ Mode"
    ...
    private fun getTuyaToken() {
        if (homeId == 0L) {
            Toast.makeText(
                this@DeviceAddingEZModeActivity,
        ...
        TuyaHomeSdk.getActivatorInstance().getActivatorToken(homeId, object : ITuyaActivatorGetToken {
            override fun onSuccess(token: String?) {
                this@DeviceAddingEZModeActivity.tuyaToken = token
                updateData()
            }
    ...
    private fun pairDevice() {
        ...
        val builder = ActivatorBuilder()
            .setContext(this@DeviceAddingEZModeActivity)
            .setSsid(ssid)
